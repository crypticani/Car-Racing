/*
	...
	2. Moving track added so that car appears to be moving
...
#define FNAME "myscore.c"  // creates a file named myscore.txt in bin folder.
...
void instructions()
{
	...
	bar3d(50,150,550,155,3,1);
	settextstyle(8,0,3);
	outtextxy(60,165,"Controls:");
	settextstyle(8,0,2);
	outtextxy(60,200,"Left arrow key : Move left");
	outtextxy(60,230,"Right arrow key: Move right");
	outtextxy(60,260,"Up arrow key   : Move Up");
	outtextxy(60,290,"Down arrow key : Move Down");
	outtextxy(60,320,"space bar      : Pause/Resume game");
	outtextxy(60,350,"Enter          : Select/Choose");
	outtextxy(60,380,"Esc            : return to menu");

	bar3d(50,420,550,415,3,1);
	settextstyle(1,0,1);
	setcolor(RED);
	outtextxy(60,440,"press esc to return to the main menu");
	kbhit();
	while(getch()!=27)
	{
		getch();
