...
void mycar1(int i)
{
	...
	arc(30+i,380,10,170,35);     //side mirror's
	arc(30+i,320,10,170,15);     //front light

	line(0+i,360,15+i,380); //top_right_corner
	line(60+i,360,45+i,380); //top_left_corner
	line(10+i,430,0+i,450); //bottom_left_corner
	line(50+i,430,60+i,450); //bottom_right_corner

	//design on bonet
	setcolor(RED);
	line(30+i,315,15+i,340);
	line(15+i,340,30+i,330);
	line(30+i,315,45+i,340);
	line(45+i,340,30+i,330);

	setcolor(GREEN);
	ellipse(30+i,450,180,360,30,20);//trunk lid
	ellipse(30+i,360,0,180,30,55);//bonet
	delay(D);
	cleardevice();
}
...
//car3
	...
	line(0+i,360,15+i,380); //top_right_corner
	line(60+i,360,45+i,380); //top_left_corner
	line(15+i,420,0+i,450); //bottom_left_corner
	line(45+i,420,60+i,450); //bottom_right_corner
